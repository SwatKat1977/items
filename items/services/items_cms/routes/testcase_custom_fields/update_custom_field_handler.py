...
class UpdateCustomFieldHandler(BaseApiRoute):
    ...
    def __init__(self,
        ...
        Args:
            ...
            service: Custom fields service used to update field definitions.
        """
    ...
    async def update_custom_field(self,
        ...
        Returns:
            ...
            404 if no field exists with the given ID.
            409 if field_name or system_name is already used by another field.
            500 on an internal database error.
        """
        body = request_msg.body

        result = await self._service.update_custom_field(
            field_id=field_id,
