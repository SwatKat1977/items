...
from routes.system.health_handler import HealthHandler
...
class TestHealthHandler(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        ...
        self.mock_state.startup_time = int(time.time()) - 5000
    ...
    async def test_health_healthy(self):
        ...
        self.assertAlmostEqual(data["uptime_seconds"], 5000, delta=2)
    ...
    async def test_health_multiple_issues(self):
        ...
        self.mock_state.service_health_reason = "Service not responding"
